...
namespace YAMP.ViewModels
{
        ...
        public async void OpenPlayer()
        {
            ...
            if (!String.IsNullOrWhiteSpace(tempMediaFile))
            {
                await Dispatcher.UIThread.InvokeAsync(async () =>
                {
                    ...
                    playerView.WindowState = WindowState.Normal;

                    playerView.ResizePlayerWindow();

                    playerView.Topmost = true;
                    var result = await playerView.ShowDialog<PlayerDialogResult>(MainWindow.GetInstance());
    ...
    public class PlayerDialogResult
    {
    }
